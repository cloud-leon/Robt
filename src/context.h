...
public:
  ...
  */
  double distance(const vertex& q1, const vertex& q2 ) const;
  ...
  */
  vertex random_sample(const vertex& q_start, const vertex& q_goal, size_t attemptLimit, bool forceBias) const;
  ...
  */
  size_t nearest_configuration(const vertex& q_rand, const size_t lastBestIndex);
  ...
  */
  bool is_subpath_collision_free(const vertex& q_near, const vertex& q_rand ) const;
  ...
  */
  path search_path(const vertex& q_init, const node& q_goal );
